		...
		success:function(data){
			...
			$.each(data,function(index,indexEntry){
				...
				if(index==0){
					...
					dataJson+="Field3:\"<input type='checkbox' name='cateLink' id='cateLink-"+indexEntry[0]+"' class='cateLink'>\",";
		...
		success:function(data){
			...
			$.each(data,function(index,indexEntry){
					...
					if(index==0){
						...
						dataJson+="{";
						dataJson+="Field1:\""+cate_link_id+"-"+(index+1)+"\",";
						dataJson+="Field2:\"<div class='level2'>- "+indexEntry[2]+"</div>\",";
						dataJson+="Field3:\"  <input type='checkbox' name='checkboxAsignLink' class='checkboxAsignLink cateLink-"+cate_link_id+"' id='link-"+cate_link_id+"-"+indexEntry[0]+"'  value='"+cate_link_id+"-"+indexEntry[0]+"'>\",";
